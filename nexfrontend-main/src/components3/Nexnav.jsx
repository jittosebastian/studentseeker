...
document.body.style.backgroundImage = "url('purple3.jpg')";
document.body.style.cssText = ` 
  background-image: url('purple3.jpg'); 
    ...
    <div>
      <Box sx={{ flexGrow: 1 }}>
        ...
        >
          ...
          <img src="logonamebg.png" alt="Logo" style={{ width: 255, height: 57, marginLeft: -16.5, marginTop: 3 ,mixBlendMode:'multipy'}} />
